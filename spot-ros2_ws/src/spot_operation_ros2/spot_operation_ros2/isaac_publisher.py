...
class JointStateRelay(Node):
    def __init__(self):
        ...
        if self.teleop_mode:
            ...
            self.get_logger().info("=== Isaac Publisher - Modo TELEOP ===")
            self.get_logger().info("Subscrevendo em: /joint_command_curobo")
        else:
            # Modo padrão: subscribe ao arm_controller
            ...
            self.get_logger().info("=== Isaac Publisher - Modo CONTROLLER ===")
    ...
    def curobo_callback(self, msg: JointState):
        """Callback para comandos do cuRobo MPC (modo teleop)."""
        # msg já é JointState com joints arm0_*
        new_msg = JointState()
    ...
    def joint_states_callback(self, msg):
        ...
        # Tenta preencher velocity/effort se disponíveis
