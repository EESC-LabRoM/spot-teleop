...
def generate_launch_description():
    ...
    startup_info = LogInfo(
        msg=[
            ...
            '=' * 70, '\n',
            '  Nodes:\n',
            '    - gripper_controller: Subscribes to /gripper/goal, publishes /gripper/command\n',
            ...
            '\n',
            '  Manual gripper control (smooth):\n',
            '    ros2 topic pub --once /gripper/goal std_msgs/Float64 "data: -1.57"\n',
            '  Manual gripper control (direct):\n',
